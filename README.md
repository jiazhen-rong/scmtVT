...
All the results in the paper is based on the `scmtVT` v1.0.0.
...
## Installation
The installation of the package shall take < 5min. 

If any question was encountered during installation, feel free to post in Issues.

Please install VGAM first to avoid errors. The following commands could be used:
